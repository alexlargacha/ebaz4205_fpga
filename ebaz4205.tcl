...
#
# ebaz4205_2020-2.tcl: Tcl script for re-creating project 'ebaz4205'
#
# Generated by Vivado on Sat Jul 31 19:13:35 CEST 2021
...
proc cr_bd_ebaz4205 { parentCell } {
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.523214",
   "Default View_TopLeft":"-235,-61",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 4 -x 1060 -y 20 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 4 -x 1060 -y 80 -defaultsOSRD
preplace port GPIO_0_0 -pg 1 -lvl 4 -x 1060 -y 100 -defaultsOSRD
preplace port MDIO_ETHERNET_0_0 -pg 1 -lvl 4 -x 1060 -y 120 -defaultsOSRD
preplace port UART_0_0 -pg 1 -lvl 4 -x 1060 -y 140 -defaultsOSRD
preplace port ENET0_GMII_RX_CLK_0 -pg 1 -lvl 0 -x 0 -y 40 -defaultsOSRD
preplace port ENET0_GMII_RX_DV_0 -pg 1 -lvl 0 -x 0 -y 60 -defaultsOSRD
preplace port ENET0_GMII_TX_CLK_0 -pg 1 -lvl 0 -x 0 -y 80 -defaultsOSRD
preplace portBus ENET0_GMII_RXD_0 -pg 1 -lvl 0 -x 0 -y 20 -defaultsOSRD
preplace portBus ENET0_GMII_TXD_0 -pg 1 -lvl 4 -x 1060 -y 40 -defaultsOSRD
preplace portBus ENET0_GMII_TX_EN_0 -pg 1 -lvl 4 -x 1060 -y 60 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -x 300 -y 140 -defaultsOSRD
preplace inst xlconcat_1 -pg 1 -lvl 2 -x 720 -y 420 -defaultsOSRD
preplace inst xlconstant_0 -pg 1 -lvl 1 -x 300 -y 430 -defaultsOSRD
preplace inst xlslice_0 -pg 1 -lvl 3 -x 930 -y 0 -defaultsOSRD
...
preplace netloc xlconstant_0_dout 1 1 1 NJ 430
preplace netloc xlslice_0_Dout 1 3 1 1040J 0n
...
levelinfo -pg 1 0 300 720 930 1060
pagesize -pg 1 -db -bbox -sgen -230 -60 1300 500
"
}
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/ebaz4205.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/ebaz4205.srcs/utils_1/imports/impl_1" -objects $obj
